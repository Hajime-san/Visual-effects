...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
    ...
    MaterialFloat Local2 = (Local1 - GetScreenPosition(Parameters).w);
    MaterialFloat Local3 = (Local2 / max(100.00000000,0.00001000));
    MaterialFloat Local4 = min(max(Local3,0.00000000),1.00000000);
    MaterialFloat Local5 = (1.00000000 * Local4);
